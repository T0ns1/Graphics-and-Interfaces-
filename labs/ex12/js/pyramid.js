...
function _build()
{
    ...
    _addFace(1,2,4,1,vec3(0,0.5,0.5));
    _addFace(2,3,4,2,vec3(0.5,0,0.5));
    _addFace(0,1,4,0,vec3(-0.5,0,0.5));
    _addFace(0,3,4,0,vec3(0.0,-0.5,0.5));
    _addFace(0,4,3,0,vec3(0.0,-0.5,0.5));
}
